...
exports.default = function PgConditionComputedColumnPlugin(builder) {
  ...
  builder.hook("GraphQLObjectType:fields:field:args", (args, build, context) => {
    ...
    const relevantAttributes = table.attributes.filter(attr => pgColumnFilter(attr, build, context) && !omit(attr, "filter"));
...
//# sourceMappingURL=PgConditionComputedColumn.js.map