...
exports.default = function PgConditionComputedColumnPlugin(builder) {
  builder.hook("GraphQLInputObjectType:fields", (fields, build, context) => {
    ...
    return extend(fields, compatibleComputedColumns.reduce((memo, { proc, pseudoColumnName }) => {
  ...
  builder.hook("GraphQLObjectType:fields:field:args", (args, build, context) => {
    ...
    (0, _assert2.default)(getNullableType(args.condition.type) === TableConditionType, "Condition is present, but doesn't match?");
    ...
    addArgDataGenerator(function connectionCondition({ condition }) {
      return {
        pgQuery: queryBuilder => {
          if (condition != null) {
            compatibleComputedColumns.forEach(({ fieldName, sqlFnName, returnType }) => {
