        ...
        return sql.fragment`
          (
            ...
            when coalesce(array_length(${sqlFullName}, 1), 0) = 0 then '[]'::json
              ...
              (
                select json_agg(${getSelectValueForFieldAndTypeAndModifier(ReturnType, fieldScope, parsedResolveInfoFragment, ident, type.arrayItemType, typeModifier)})
    ...
    return extend(fields, table.attributes.reduce((memo, attr) => {
      ...
      memo = extend(memo, {
        [fieldName]: fieldWithHooks(fieldName, pgAddSubfield(fieldName, attr.name, attr.type, {
          description: attr.description,
          type: nullableIf(GraphQLNonNull, isPgBaseInput || isPgPatch || !attr.isNotNull && !attr.type.domainIsNotNull && !attr.tags.notNull || attr.hasDefault || attr.identity === "d", pgGetGqlInputTypeByTypeIdAndModifier(attr.typeId, attr.typeModifier) || GraphQLString)
