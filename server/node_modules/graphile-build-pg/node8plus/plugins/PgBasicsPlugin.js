...
var _pgField = require("./pgField");

var _pgField2 = _interopRequireDefault(_pgField);
...
const omitUnindexed = omit => (entity, permission) => {
...
function sqlCommentByAddingTags(entity, tagsToAdd) {
  ...
  const tagsSql = Object.keys(tags).reduce((memo, tag) => {
    ...
    const highlightOrNot = tag in tagsToAdd ? _chalk2.default.bold.green : identity;
...
exports.default = function PgBasicsPlugin(builder, {
  ...
  builder.hook("build", build => {
    ...
    return build.extend(build, {
      ...
      pgQueryFromResolveData: (0, _queryFromResolveDataFactory2.default)(),
