...
exports.default = function PgTypesPlugin(builder, {
  ...
  builder.hook("build", build => {
    ...
    */
    ...
    const JSONType = pgExtendedTypes ? (0, _GraphQLJSON2.default)(graphql, inflection.builtin("JSON")) : SimpleJSON;
    ...
    const oidLookup = {
      "20": stringType(inflection.builtin("BigInt"), "A signed eight-byte integer. The upper big integer values are greater then the max value for a JavaScript number. Therefore all big integers will be output as strings and not numbers."), // bitint - even though this is int8, it's too big for JS int, so cast to string.
      "21": GraphQLInt, // int2
      "23": GraphQLInt, // int4
    ...
    const reallyEnforceGqlTypeByPgTypeAndModifier = (type, typeModifier) => {
      ...
      if (!gqlTypeByTypeIdAndModifier[type.id][typeModifierKey] && type.type === "r") {
        ...
        pgTweaksByTypeIdAndModifer[type.id][typeModifierKey] = fragment => sql.fragment`case
